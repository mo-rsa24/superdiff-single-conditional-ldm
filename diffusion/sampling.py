...
from diffusion.sde_vp import alpha_fn
...
def Ancestral_Sampler(
    ...
    def loop_body(i, state):
        ...
        z0_pred = (z - sigma_t * eps_hat) / alpha_t
    ...
    p_low = np.percentile(x_rec_np, 1, axis=(1, 2, 3), keepdims=True)
    p_high = np.percentile(x_rec_np, 99, axis=(1, 2, 3), keepdims=True)
